...
public class SparkGeneAggregationByIndividual {
   ...
   // r1 up 1.04 hdfs://cm01:8020/test/input 
   public static void main(String[] args) throws Exception {
    ...
    JavaSparkContext ctx = new JavaSparkContext("local","SparkGeneAggregationByIndividual");
...
//    JavaRDD<String> records = readInputFiles(ctx, biosets);
   ...
   JavaRDD<String> records = ctx.textFile(biosets);
