...
public class SparkTtest {
   ...
   // D:\timetable\timetable.txt hdfs://cm01:8020/test/bioset local
...
//      JavaSparkContext ctx =   SparkUtil.createJavaSparkContext(yarnResourceManager);
      JavaSparkContext ctx =   SparkUtil.createJavaSparkContext("local","SparkTtest");
...
//      JavaRDD<String> biosets = readBiosetFiles(ctx, biosetFileNames);
      JavaRDD<String> biosets = ctx.textFile(biosetFileNames);
