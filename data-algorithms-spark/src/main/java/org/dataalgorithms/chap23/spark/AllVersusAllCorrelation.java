...
public class AllVersusAllCorrelation implements java.io.Serializable {
   ...
   public static void main(String[] args) throws Exception {
      ...
      JavaSparkContext ctx = SparkUtil.createJavaSparkContext("local","AllVersusAllCorrelation");
...
//      JavaRDD<String> biosets = readBiosets(ctx, list);
      JavaRDD<String> biosets = ctx.textFile(filename);
